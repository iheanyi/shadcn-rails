import type { Controller, ControllerConstructor } from "@hotwired/stimulus"

export type StimulusControllerConstructor = ControllerConstructor

export type ShadcnControllerIdentifier =
  | "shadcn--accordion"
  | "shadcn--avatar"
  | "shadcn--calendar"
  | "shadcn--carousel"
...
declare module "@hotwired/stimulus" {
  interface Controller<ElementType extends Element = Element> {
    // Stimulus defines target/value accessors at runtime from static class metadata.
