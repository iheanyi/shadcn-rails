...
export default class extends Controller<HTMLElement> {
  ...
  open() {
    ...
    if (this.hasTemplateTarget && !this.portal) {
      ...
      this.portal.querySelectorAll('[data-action*="shadcn--dialog#close"]').forEach((el: HTMLElement) => {
        el.addEventListener("click", (e: ShadcnEvent) => {
          e.preventDefault()
          this.close()
        })
      })
  ...
  handleClickOutside(event: ShadcnEvent) {
