...
export default class extends Controller<HTMLElement> {
  ...
  select(event: ShadcnEvent) {
    ...
    this.itemTargets.forEach((i: HTMLElement) => {
  ...
  updateSelection() {
    ...
    visibleItems.forEach((item: HTMLElement, index: number) => {
   ...
   */
  getVisibleItems() {
    return this.itemTargets.filter((item: HTMLElement) => item.style.display !== "none")
  }
