...
export default class extends Controller<HTMLElement> {
  ...
  scrollToIndex(index: number, animate = true) {
    ...
    this.itemTargets.forEach((target: HTMLElement, i: number) => {
  ...
  getAlignOffset(item: HTMLElement, dimension: "width" | "height") {
  ...
  handleTouchStart(event: ShadcnEvent) {
  ...
  handleTouchEnd(event: ShadcnEvent) {
