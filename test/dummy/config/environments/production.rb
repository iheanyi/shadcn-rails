...
Rails.application.configure do
  ...
  # Cache assets for far-future expiry since they are fingerprinted.
  ...
  config.active_record.attributes_for_inspect = [:id] if defined?(ActiveRecord)
...
# Enable ViewComponent previews in production for Lookbook
