...
class ScrollAreaComponentTest < ViewComponent::TestCase
  ...
  def test_stylesheet_positions_scrollbars_as_overlays
    ...
    assert_match %r!\[data-slot="scroll-area-viewport"\]\s*\{[^}]*-ms-overflow-style: none;[^}]*scrollbar-width: none;!m, css
    assert_match %r!\[data-slot="scroll-area-viewport"\]::\-webkit-scrollbar\s*\{[^}]*display: none;!m, css
