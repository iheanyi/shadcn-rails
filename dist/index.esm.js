...
const DAY_WRAPPER_CLASSES$1 = "group/day relative aspect-square h-full w-full flex-1 p-0 text-center select-none [&:last-child[data-selected=true]_button]:rounded-r-md [&:first-child[data-selected=true]_button]:rounded-l-md";
const EMPTY_DAY_CLASSES$1 = "invisible size-(--cell-size) min-w-(--cell-size) flex-1";
/**
    ...
    renderDays() {
        ...
        while (currentDate <= endDate) {
            ...
            if (isOutside && !this.showOutsideDaysValue) {
                appendCell(`<div class="${EMPTY_DAY_CLASSES$1}"></div>`);
            ...
            if (isFocused)
                wrapperAttrs.push('data-focused="true"');
            ...
            appendCell(`<div class="${DAY_WRAPPER_CLASSES$1}" ${wrapperAttrs.join(" ")}><button type="button" class="${classes}" data-date="${dateStr}" data-shadcn--calendar-target="day" ${dataAction} ${ariaAttrs.join(" ")}>${currentDate.getDate()}</button></div>`);
            currentDate.setDate(currentDate.getDate() + 1);
        }
...
function connectedControllers() {
    return Array.from(controllers$1).filter((controller) => {
...
const controllers = {
    "shadcn--accordion": default_1$t,
    "shadcn--avatar": default_1$s,
    "shadcn--calendar": CalendarController,
    "shadcn--carousel": default_1$r,
...
export { default_1$t as AccordionController, default_1$s as AvatarController, default_1$u as BaseMenuController, CalendarController, default_1$r as CarouselController, default_1$q as CheckboxController, default_1$p as CollapsibleController, default_1$o as ComboboxController, default_1$n as CommandController, default_1$m as CommandDialogController, default_1$l as ContextMenuController, DatePickerController, default_1$k as DialogController, default_1$j as DrawerController, default_1$i as DropdownController, default_1$h as HoverCardController, default_1$1 as InputOtpController, default_1$g as MenubarController, default_1$f as NavigationMenuController, default_1$e as PopoverController, default_1$c as RadioGroupController, default_1$d as ResizableController, default_1$b as ScrollAreaController, default_1$a as SelectController, default_1$9 as SheetController, default_1 as SidebarController, default_1$8 as SliderController, SonnerController, default_1$7 as SwitchController, default_1$6 as TabsController, default_1$5 as ToastController, default_1$4 as ToggleController, default_1$3 as ToggleGroupController, default_1$2 as TooltipController, controllers, index as default, dismiss, positionAtPoint, positionFloating, registerShadcnControllers, toast };
